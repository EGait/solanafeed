    ...
    <main className="bg-[#0a0a0f] min-h-screen text-gray-100">
      ...
      <div className="max-w-2xl mx-auto px-6 md:px-8 py-12">
        ...
        <div className="prose prose-invert max-w-none">
          ...
          <p className="text-gray-400 text-sm leading-relaxed mb-6">
            <span className="text-gray-200">Bear:</span> Named defendant in an active fraud lawsuit, revenue concentrated in a collapsed niche, weak value-accrual linkage between protocol fees and the token, launchpads increasingly keeping liquidity in-house, and only eight months of price history.
          </p>
